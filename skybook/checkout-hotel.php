		...
		<div class="container margin_60">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="step first">
                            <h3>1. Hotel Details</h3>
                            <div class="box_general summary">
                                <?php
                                    $hotel_id=$_GET['hotel_id'];
                                    $query_bus=mysqli_query($con,"SELECT * from hotel WHERE hotel_id=$hotel_id") or die(mysqli_error($con));
                                ...
                                ?>
                                    <ul>
                                        <li><img height="200" src="<?php echo str_replace("../","./",$fetch['hotel_image']); ?>" alt="" srcset=""></li>
                                        <li></li>
                                    </ul>
                                <?php
                                        }
                            ...
                            <div class="box_general summary">
                                <?php
                                    ...
                                    if(mysqli_num_rows($query_bus)){
                                        while($fetch=mysqli_fetch_array($query_bus))
                                        {
                                            $hotel_cost=$fetch['hotel_cost'];
                                ?>
                                    <ul>
                                        <li>ID:<span class="float-right"><b><?php echo $fetch['hotel_id']; ?></b></span></li>
                                        <li>Name:<span class="float-right"><b><?php echo $fetch['hotel_name']; ?></b></span></li>
                                        <li>Price: <span class="float-right"><b>&#8377;<?php echo $fetch['hotel_cost']; ?></b></span></li>
                                        <li></li>
                                    </ul>
                                <?php
                                        }
            ...
            <?php
                if(isset($_POST['submit']))
                {
                    ...
                    $_SESSION['amount']=$hotel_cost;
                    $_SESSION['hotel_id']=$hotel_id;
                    $_SESSION['invoice_number']=$invoice;

                    ?>
                        <script>
                            window.location = 'payment/buy-hotel.php';
                        </script>
                    <?php
                }
            ?>
