                    ...
                    <div class="card-body">
                      <form method="post" onsubmit="return validateForm()" enctype="multipart/form-data">
                        ...
                        <div class="mb-2">
                            ...
                            onclick="cleardetailsvalidation()" onkeypress="cleardetailsvalidation()"></textarea>
                      ...
                      <?php
                        if(isset($_POST['submit']))
                        {
                            ...
                            if($isuploaded)
                            {
                              ...
                              $sql="INSERT INTO package (package_name,package_date,package_details,
                              package_cost,package_image) VALUES ('$name','$date','$details',
                              '$cost','$target_file')";
                                  ...
                                  ?>
                                      <script>
                                          Swal.fire(
                                          {
                                              ...
                                              window.location='add-package.php';
                                          });
                                      </script>
                                  <?php
                              }
