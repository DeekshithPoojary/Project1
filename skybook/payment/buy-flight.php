...
<div class="container mt-5">
	...
	<div class="row justify-content-center">
		<div class="col-12 col-md-10 col-lg-10 pb-20 pt-20">
                    ...
                    <form action="pgRedirect-flight.php" method="POST">
                        <input type="hidden" class="form-control" name="ORDER_ID" value="<?php echo $ORDER_ID; ?>">
                    	<input type="hidden" class="form-control" name="user_id" value="<?php echo $USER_ID; ?>">
                    	<input type="hidden" class="form-control" name="flight_id" value="<?php echo $FLIGHT_ID; ?>">
                    	...
                    	<input type="hidden" class="form-control" name="SEAT" value="<?php echo $SEAT; ?>">
                            ...
                            <div class="card-body p-3 text-center">        <!--Body-->
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-2">
                                       ...
                                       <p class="m-2">Flight ID : <strong><?php echo $FLIGHT_ID; ?></strong></p>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-2">
                                        ...
                                        <p class="m-2">SEAT NUMBER : <strong><?php echo $SEAT ?></strong></p>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group mb-2">
