...
<div class="container mt-5">
	...
	<div class="row justify-content-center">
		<div class="col-12 col-md-10 col-lg-10 pb-20 pt-20">
                    ...
                    <form action="pgRedirect-hotel.php" method="POST">
                        <input type="hidden" class="form-control" name="ORDER_ID" value="<?php echo $ORDER_ID; ?>">
                    	<input type="hidden" class="form-control" name="user_id" value="<?php echo $USER_ID; ?>">
                    	<input type="hidden" class="form-control" name="hotel_id" value="<?php echo $HOTEL_ID; ?>">
                            ...
                            <div class="card-body p-3 text-center">        <!--Body-->
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-2">
                                       ...
                                       <p class="m-2">Hotel ID : <strong><?php echo $HOTEL_ID; ?></strong></p>
                                    </div>
                                </div>
