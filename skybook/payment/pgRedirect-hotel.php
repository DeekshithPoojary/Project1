...
$store_payment="INSERT INTO hotel_booking (user_id,hotel_id,amount,
				invoice_number,status,booking_date)
				VALUES ('$userid','$hotelid','$TXN_AMOUNT','$invoice',
				'BOOKING CONFIRMED','$BOOKING_DATE')";
