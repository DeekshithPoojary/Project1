...
<div class="container">
	<div class="row text-center">
        ...
        <img src="./check.png" class="img-responsive col-md-4 col-sm-4 col-lg-2">
        <h3>Dear, User</h3>
        <p style="font-size:20px;color:#5C5C5C;">Thank you for the Order. Please Feel happy to check your order details in the dashboard. Invoice will be sent to your Mail ID shortly.</p>
        <h4>ORDER ID: <strong>#<?php echo $_POST['ORDERID']; ?></strong></h4>
        <h4>Transaction ID: <strong><?php echo $_POST['TXNID']; ?></strong></h4>

        <a href="../user/view-orders.php" class="btn btn-success">Continue to Dashboard </a>
    <br><br>
        </div>
	</div>
</div>
...
<div class="container">
	...
	<div class="col-2"></div>
        ...
        <img src="./failure.png" class="img-responsive col-md-2 col-sm-2 col-lg-4">
